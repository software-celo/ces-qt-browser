...
class ConfigBackend : public QObject
{
    ...
    Q_PROPERTY(bool persistentCacheEnable READ getPersistentCacheEnable NOTIFY persistentCacheEnableChanged FINAL)
...
signals:
    ...
    void persistentCacheEnableChanged();
